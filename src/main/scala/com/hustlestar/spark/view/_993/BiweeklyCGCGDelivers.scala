...
object BiweeklyCGCGDelivers extends ReadWriteHelper with BiweeklyCGLogic {

  def main(args: Array[String]): Unit = {
    val sparkSession = SparkUtils.createSparkSession("biweekly_control_group_delivers")
